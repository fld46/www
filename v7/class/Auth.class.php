...
class Auth {
    ...
    public function register($db,$username, $password, $email){
        ...
        $message_txt="Afin de completer votre inscription, merci de cliquer sur ce lien : \n\n http://webfld.ddns.net/account/confirm.php?id=".$user_id."&token=".$token."";
        $message_html="<html><head></head><body><b>Bonjour</b>,<p>Afin de completer votre inscription, merci de cliquer sur ce lien :</p><p><a href=\"http://webfld.ddns.net/account/confirm.php?id=".$user_id."&token=".$token."\">Cliquez ici</a></p></body></html>";
    ...
    if(password_verify($password, $user->password)){
     ...
     public function resetPassword($db, $email){
        ...
        $message_txt="Afin de réinitialiser votre mot de passe merci de cliquer sur ce lien : \n\n http://webfld.ddns.net/account/reset.php?id=".$user->id."&token=".$reset_token."";
        $message_html="<html><head></head><body><b>Bonjour</b>,<p>Afin de réinitialiser votre mot de passe merci de cliquer sur ce lien :</p><p><a href=\"http://webfld.ddns.net/account/reset.php?id=".$user->id."&token=".$reset_token."\">Cliquez ici</a></p></body></html>";
        //mail($email, 'Confirmation de votre inscription', "Afin de completer votre inscription, merci de cliquer sur ce liens : \n\n http://192.168.0.1/v4/account/confirm.php?id=".$user_id."&token=".$token."");
        $mail = new mail();
